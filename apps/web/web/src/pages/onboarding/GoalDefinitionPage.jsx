        ...
        <div>
          ...
          <div className="relative">
            <textarea
              ...
              className="w-full p-4 text-sm border border-white/10 rounded-2xl focus:ring-2 focus:ring-blue-600 focus:border-transparent outline-none leading-relaxed text-white"
