    ...
    <div className="min-h-screen bg-transparent flex flex-col">
      ...
      <div className="flex-1 flex max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-6 gap-8">
        <aside className="hidden md:flex flex-col w-64 shrink-0 gap-6">
          <div className="bg-black/40 backdrop-blur-xl border border-white/10 rounded-2xl p-3 shadow-[0_0_10px_rgba(79,70,229,0.1)]">
            <div className="px-3 py-2 border-b border-white/5 mb-2 flex items-center gap-2 text-white font-bold text-xs">
                  ...
                  <NavLink
                    ...
                    className={({ isActive }) =>
                      `flex items-center gap-3 px-3.5 py-2.5 rounded-xl text-xs font-semibold transition ${
                        isActive
                          ? 'bg-slate-800 text-white shadow-[0_0_10px_rgba(79,70,229,0.1)]'
