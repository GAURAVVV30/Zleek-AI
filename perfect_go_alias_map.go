var nodeAliasMap = map[string]string{
	...
	"ml_02_linear_algebra_and_calculus": "machine_learning_m01_programming_fundamentals_for_ml",
	"ml_03_probability_and_statistics": "machine_learning_m01_programming_fundamentals_for_ml",
