...
export default function GlobalSearchModal({ isOpen, onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-start justify-center pt-20 px-4">
      ...
      <div className="relative w-full max-w-xl bg-white rounded-2xl shadow-elevated border border-slate-200 overflow-hidden z-10 animate-in fade-in zoom-in-95 duration-150">
          ...
          {query.trim().length === 0 ? (
            ...
            results.map((item, idx) => (
              <button
                ...
                className="w-full p-3 rounded-xl hover:bg-blue-50/60 transition flex items-center justify-between text-left group"
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-500">{item.match}</p>
                  </div>
                </div>
